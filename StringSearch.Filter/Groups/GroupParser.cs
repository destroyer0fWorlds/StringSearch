    ...
    class GroupParser
    {
        ...
        private IEnumerable<IGroup> RecursiveParse(string value)
        {
            ...
            foreach (var group in groups)
            {
                ...
                {
                    var unknownGroupMessage = $"Invalid format '{group}'. Conditions must be surrounded by parentheses and operators must be surrounded by square braces: (name[operator]value).";
